...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 ">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img class="mx-auto h-10 w-auto" src="{{ asset('img/todo-icon.png') }}" alt="Your Company">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm ">
      ...
      <form class="space-y-6" action="{{ route('login.auth') }}" method="POST">
        ...
        <div>
          ...
          <div class="pt-4"><a href="{{ route('regis') }}" class=" text-center text-blue-600 text-end">Register</a></div>
        </div>
      </form>
    </div>
  </div>  
